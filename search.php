        ...
        <div id="corp">
                ...
                <?php
                    ...
                    if (isset($_GET['query'])) {
                        ...
                        $query = "SELECT * FROM products WHERE p_name LIKE '%$searchQuery%'";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<a href='productspage.php?id=" . htmlspecialchars($row['id_p']) . "'>";
                                echo "<img src='" . htmlspecialchars($row['picture']) . "' alt='" . htmlspecialchars($row['p_name']) . "' width='200' height='200'>";
                                echo "<h3>" . htmlspecialchars($row['p_name']) . "</h3>";
                                echo "</a>";
                                echo "</div>";
                                if (($counter + 1) % 4 === 0 || $counter === mysqli_num_rows($result) - 1) {
                                    echo "</div>"; 
                                }
                                $counter++;
                            }
