<html>
    ...
    <body>
        <div id="corp">
            ...
            <div class="boxdescriere">
                <p>
                    We are seniors at Colegiul National "Avram Iancu" Campeni and we made this website that works like an online music shop. My name is Joldes Costin and my partener's name is Burz Ioan. The website is not complete but it has a lot of implementations like a real one. 
                </p>
            </div>
            <div class="boxdescrieree">
                <img src="Imagini/costin.jpg">
                <img src="Imagini/ionut.JPG">
            </div>
            <div id="footer1">
                <div id="footer">
                    <div id="content">
