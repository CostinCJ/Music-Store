<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="chitari.css">
    ...
    <body>
        <div id="corp">
                ...
                <?php
                  include('connect.php');
                  $query = "SELECT id_p, p_name, picture FROM products WHERE category = 'Chitara'";
                ...
                <ul class="product-grid">
                  <?php while ($row = mysqli_fetch_array($result)) { ?>
                    <li class="product-item">
                      <a style="color:black; text-decoration:none;" href="productspage.php?id=<?php echo $row['id_p']; ?>">
                        <img src="<?php echo $row['picture']; ?>" alt="<?php echo $row['p_name']; ?>" class="product-image">
                        <div class="product-name"><?php echo $row['p_name']; ?></div>
                      </a>
                    </li>
                  <?php } ?>
                </ul>
